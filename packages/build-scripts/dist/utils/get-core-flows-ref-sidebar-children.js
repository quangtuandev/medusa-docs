...
import { getSidebarItemLink } from "../index.js";
export default async function getCoreFlowsRefSidebarChildren() {
    ...
    for (const directory of directories) {
        ...
        const workflowItems = [];
        const stepItems = [];
        const readItemsFromChildDirs = async (type) => {
            const childNamespaceBasePath = path.join(basePath, directory.name, `${type}_${directory.name}`, "functions");
