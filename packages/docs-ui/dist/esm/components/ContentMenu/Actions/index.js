...
export const ContentMenuActions = () => {
    ...
    return (React.createElement("div", { className: "flex flex-col gap-docs_0.5" },
        React.createElement(Link, { className: "flex items-center gap-docs_0.5 text-medusa-fg-subtle text-x-small-plus hover:text-medusa-fg-base", href: `${pageUrl}/index.html.md` },
            React.createElement(MarkdownIcon, { width: 15, height: 15 }),
            "View as Markdown"),
        React.createElement("button", { className: "appearance-none p-0 flex items-center gap-docs_0.5 text-medusa-fg-subtle text-x-small-plus hover:text-medusa-fg-base", onClick: handleAiAssistantClick },
            React.createElement(BroomSparkle, { width: 15, height: 15 }),
