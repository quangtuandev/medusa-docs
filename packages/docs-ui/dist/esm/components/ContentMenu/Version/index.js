...
export const ContentMenuVersion = () => {
    const { config: { version }, } = useSiteConfig();
    ...
    return (React.createElement(Card, { type: "mini", title: `New version`, text: `v${version.number} details`, closeable: true, onClose: handleClose, href: version.releaseUrl, hrefProps: {
            target: "_blank",
            rel: "noopener noreferrer",
        }, themeImage: version.bannerImage, imageDimensions: {
            width: 64,
            height: 40,
        }, className: clsx("!border-0 !bg-medusa-bg-component hover:!bg-medusa-bg-component-hover", "hover:!bg-medusa-bg-component-hover animation-fill-forwards", "opacity-0"), iconClassName: clsx("!shadow-none border-[0.5px] border-medusa-alphas-alpha-250"), cardRef: cardRef }));
};
