...
export const Badge = ({ className, variant, badgeType = "default", children, childrenWrapperClassName, }) => {
    return (React.createElement("span", { className: clsx("text-compact-x-small-plus text-center", badgeType === "default" &&
        ...
        "badge", className) },
        badgeType === "shaded" && (React.createElement(ShadedBgIcon, { variant: variant, className: clsx("absolute top-0 left-0 w-full h-full") })),
        React.createElement("span", { className: clsx(badgeType === "shaded" && "relative z-[1]", childrenWrapperClassName) }, children)));
};
