...
export const ApiRunnerParamInput = ({ paramName, paramValue, objPath, setValue, }) => {
    if (Array.isArray(paramValue)) {
        return (React.createElement(ApiRunnerParamArrayInput, { paramName: paramName, paramValue: paramValue, objPath: objPath, setValue: setValue }));
    }
    if (typeof paramValue === "object") {
        return (React.createElement(ApiRunnerParamObjectInput, { paramName: paramName, paramValue: paramValue, objPath: objPath, setValue: setValue }));
    }
    return (React.createElement(InputText, { name: paramName, onChange: (e) => {
            setValue((prev) => {
