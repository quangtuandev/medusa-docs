...
export const TechArticleJsonLd = () => {
    const { config: { baseUrl, basePath, description: configDescription, titleSuffix }, frontmatter, } = useSiteConfig();
    ...
    return (React.createElement("script", { type: "application/ld+json", dangerouslySetInnerHTML: { __html: jsonLdData } }));
};
