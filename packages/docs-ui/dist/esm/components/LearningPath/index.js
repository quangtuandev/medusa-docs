...
export const LearningPath = ({ pathName, className = "", }) => {
    ...
    return (React.createElement("div", { className: clsx("rounded shadow-elevation-card-rest dark:shadow-elevation-card-rest-dark bg-medusa-bg-subtle mt-docs_1.5 mb-docs_4", className) },
