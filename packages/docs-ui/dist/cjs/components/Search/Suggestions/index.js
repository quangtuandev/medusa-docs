...
const SearchSuggestions = ({ suggestions }) => {
    ...
    return (react_1.default.createElement("div", { className: "h-full overflow-auto px-docs_0.5" },
        commands.length > 0 && (react_1.default.createElement(react_1.default.Fragment, null,
            ...
            commands.map((command, index) => (react_1.default.createElement(Item_1.SearchSuggestionItem, { onClick: () => setCommand(command), key: index, tabIndex: index },
                command.icon,
                react_1.default.createElement("span", { className: "flex-1" }, command.title),
                command.badge && react_1.default.createElement(components_1.Badge, { ...command.badge })))))),
