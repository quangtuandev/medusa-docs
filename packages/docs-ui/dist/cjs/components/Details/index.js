...
const Details = ({ openInitial = false, summaryContent, summaryElm, children, heightAnimation = false, ...props }) => {
    const [open, setOpen] = (0, react_1.useState)(openInitial);
    const ref = (0, react_1.useRef)(null);
    const childrenWrapperRef = (0, react_1.useRef)(null);
    const { getCollapsibleElms, setCollapsed } = (0, hooks_1.useCollapsible)({
    ...
    return (react_1.default.createElement("details", { ...props, ref: ref, open: open, onClick: (event) => {
        ...
        getCollapsibleElms(react_1.default.createElement(react_1.Suspense, { fallback: react_1.default.createElement(components_1.Loading, { className: "!mb-docs_2 !mt-0" }) },
            react_1.default.createElement("div", { ref: childrenWrapperRef }, children)))));
};
