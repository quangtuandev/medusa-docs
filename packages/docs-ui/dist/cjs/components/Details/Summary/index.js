...
const DetailsSummary = ({ title, subtitle, children, badge, expandable = true, open = false, className, titleClassName, hideExpandableIcon = false, summaryRef, ...rest }) => {
    return (react_1.default.createElement("summary", { className: (0, clsx_1.default)("py-docs_0.75 flex items-center justify-between", expandable && "cursor-pointer", !expandable &&
