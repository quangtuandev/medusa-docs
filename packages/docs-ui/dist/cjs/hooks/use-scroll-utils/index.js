...
function useScrollControllerContextValue({ scrollableSelector, }) {
    ...
    const topMargin = (0, react_1.useMemo)(() => {
        // might need a better way to set these static values
        return showCollapsedNavbar ? 112 : 56;
    }, [showCollapsedNavbar]);
    const scrollToTop = (top, parentTop) => {
        const parentOffsetTop = parentTop !== undefined
            ? parentTop
            : (0, utils_1.isElmWindow)(scrollableElement)
                ? 0
...
function ScrollControllerProvider({ children, scrollableSelector = "", }) {
    ...
    (0, use_keyboard_shortcut_1.useKeyboardShortcut)({
        ...
        action: (e) => {
            ...
            if ((0, utils_1.isElmWindow)(value.scrollableElement) ||
            ...
            const pageScrollAmount = value.scrollableElement.clientHeight - scrollThreshold;
            switch (e.key) {
                case "ArrowUp":
