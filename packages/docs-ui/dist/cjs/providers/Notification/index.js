...
const NotificationProvider = ({ children, initial = [], }) => {
    const generateId = () => (0, react_uuid_1.default)();
    const normalizedInitial = (0, react_1.useMemo)(() => {
        return initial.map((notif) => ({
            id: generateId(),
            ...notif,
        }));
    }, [initial]);
    const [notifications, dispatch] = (0, react_1.useReducer)(notificationReducer, normalizedInitial);
