...
export type ArraySchemaObject = Omit<OpenAPIV3.ArraySchemaObject, "properties" | "anyOf" | "allOf" | "oneOf" | "examples"> & {
    items: SchemaObject;
...
export type NonArraySchemaObject = Omit<OpenAPIV3.NonArraySchemaObject, "properties" | "anyOf" | "allOf" | "oneOf" | "examples" | "additionalProperties"> & {
    properties: PropertiesObject;
